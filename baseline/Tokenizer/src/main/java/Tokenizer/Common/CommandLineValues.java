...
public class CommandLineValues {
    ...
    public boolean PrintPaths = false;
    ...
    //@Option(name = "--method", required = false)
    ...
    public CommandLineValues(String... args) throws ParseException {
        ...
        Option method = new Option(null, "method", true, "Parse at method level");
        ...
        try {
            ...
            if (cmd.hasOption("method")) Method = Boolean.parseBoolean(cmd.getOptionValue("method"));
