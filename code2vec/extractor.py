...
class Extractor:
    ...
    def extract_paths(self, path):
        command = ['java', '-cp', self.jar_path, 'JavaExtractor.App', '--code2vec', 'true', '--max_path_length',
                   str(self.max_path_length), '--max_path_width', str(self.max_path_width), '--file', path, '--no_hash', 'true', '--evaluate', 'true']
